        ...
        <div class="gap-y-6 w-full flex flex-col">
            ...
            <div class="flex flex-col md:flex-row md:space-x-6">
                <div class="flex flex-col w-full md:w-1/2 space-y-2">
                    <label for="fechaApertura" class="text-lg font-semibold text-gray-700">Fecha
                        Apertura:</label>
                ...
                <div class="flex flex-col w-full md:w-1/2 mt-4 md:mt-0 space-y-2">
                    <label for="fechaCierre" class="text-lg font-semibold text-gray-700">Fecha Cierre:</label>
                ...
                <div class="flex md:flex-row flex-col w-full justify-center items-center md:space-x-6">
                    ...
                    <div class="flex flex-col w-full md:w-48 mt-4 md:mt-0">
                        <button @click="removeStage"
                            class="px-4 py-2 bg-red-500 text-white rounded-md hover:bg-red-600">Quitar Etapa
                        </button>
                    </div>
                </div>
